...
// 获取xmlHttpRequest 实例，浏览器特有的
AspNetComet.prototype.getXMLHttpRequest = function AspNetComet_getXMLHttpRequest() {
 ...
 * 
 */
AspNetComet.prototype.subscribe = function AspNetComet_subscribe() {
...
AspNetComet.prototype.addSuccessHandler = function AspNetComet_addSuccessHandler(func){
    this.successHandlers[this.successHandlers.length] = func;
}

AspNetComet.prototype.addFailureHandler = function AspNetComet_addFailureHandler(func){
    this.failureHandlers[this.failureHandlers.length] = func;
}

AspNetComet.prototype.addTimeoutHandler = function AspNetComet_addTimeoutHandler(func){
    this.timeoutHandlers[this.timeoutHandlers.length] = func;
}

AspNetComet.prototype.callSuccessHandlers = function AspNetComet_callSuccessHandlers(privateToken, alias, message){
...
AspNetComet.prototype.callFailureHandlers = function AspNetComet_callFailureHandlers(privateToken, alias, error){
...
AspNetComet.prototype.callTimeoutHandlers = function AspNetComet_callTimeoutHandlers(privateToken, alias)
{
...
AspNetComet.prototype.unsubscribe =function AspNetComet_unsubscribe()
{
    this.enabled = false;
}
